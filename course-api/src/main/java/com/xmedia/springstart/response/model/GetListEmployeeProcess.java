...
public class GetListEmployeeProcess {
    private static String employeeStatus = null;

    public static List<EmployeeProcessList> getListEmployeeProcess() throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(getListEmployeeProcess());
    }
}
